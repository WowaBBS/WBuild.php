...
:::call "%ProgramFiles(x86)%/Microsoft Visual Studio 14.0/VC\bin\amd64\vcvars64.bat"
::call "%ProgramFiles(x86)%/Microsoft Visual Studio 14.0/VC\bin\amd64_x86\vcvarsamd64_x86.bat"
:::call "%ProgramFiles(x86)%/Microsoft Visual Studio 14.0/VC\bin\x86_amd64\vcvarsx86_amd64.bat"
